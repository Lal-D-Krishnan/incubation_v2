...
function  HomeP() {
 ...
 await axios.get(`http://localhost:5002/admin/getRoomsData/${userdata._id}`).then(async(response)=>{
  ...
  async function getData(){
    console.log( `am i getting the userId in the frontend  , ${userdata._id}`);
    await  axios.get(`http://localhost:5002/applications/${userdata._id}`).then((response)=>{
            ...
            <div className='m-auto' >
              ...
              <div
                ...
                class={` rounded cursor-pointer ${
                  seat.status ? "bg-stone-700" : "bg-teal-400"
