...
function ASubmittedApplications() {
  ...
  useEffect(() => {
    const userInfo = localStorage.getItem("click");
  ...
  function applicationData() {
    axios.get("http://localhost:5002/admin/get-applications").then((response) => {
...
<h1 className="text-center mt-2 text-xl font-bold" >Submitted applications</h1>
            ...
            {showModal? <AdminViewApplication data={appsData} />:null}
...
export default ASubmittedApplications;
