...
function ApplicationForm() {
  ...
  const appFind = async () => {
    const data = await axios.get(`http://localhost:5002/submit-status/${user_id}`
    ).then((response) => {


      if (response.data.status) {
        console.log("http://localhost:5002/submit-status/ ; the response.data.status is true");
        setAppstatus(true);
        // navigate('/status')
      } else {
        setAppstatus(false);
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <input
                  ...
                  name="name"
                  className={`appearance-none block w-full bg-gray-200  text-gray-700 border ${errName.bool ? "border-red-500" : null
              ...
              <div className="w-full md:w-2/3 px-3">
                ...
                <input
                  ...
                  name="address"
                  className={`appearance-none block w-full mb-2 bg-gray-200 text-gray-700 border ${errAddress.bool ? "border-red-500" : null
              ...
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                  ...
                  name="city"
                  className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${errCity.bool ? "border-red-500" : null
                    } rounded py-3 px-4 mb-2 leading-tight focus:outline-none focus:bg-white`}
                  id="grid-first-name"
                  type="text"
                  placeholder="calicut"
              ...
              <div className="w-full md:w-1/2 px-3">
                ...
                <input
                  ...
                  name="state"
                  className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${errState.bool ? "border-red-500" : null
                    }   rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500`}
                  id="grid-last-name"
                  type="text"
                  placeholder=" kerala"
              ...
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                  ...
                  name="email"
                  className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${errEmail.bool ? "border-red-500" : null
                    } rounded py-3 px-4 mb-2 leading-tight focus:outline-none focus:bg-white`}
                  id="grid-first-name"
                  type="text"
              ...
              <div className="w-full md:w-1/2 px-3">
                ...
                <input
                  ...
                  name="phone"
                  className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${errPhone.bool ? " border-red-500" : null
                    } rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500`}
                  id="grid-last-name"
                  type="number"
